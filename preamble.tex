...
\mynames{Thomas\bibnamedelima Robinson}
...
\definecolor{SwishLineColour}{HTML}{FF6600}
\definecolor{MarkerColour}{HTML}{990000}
% \definecolor{NameColour}{HTML}{993D00}
...
\newcommand{\stackdate}[2]{\stackanchor[1pt]{\scriptsize{\textsc{#1}}}{#2}}